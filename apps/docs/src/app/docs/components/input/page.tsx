...
const props = [
  ...
  { name: "hint", type: "string", description: "Texto auxiliar exibido abaixo do campo" },
  {
    ...
    type: "boolean",
    default: "false",
    description: "Ativa o estado de erro (borda vermelha + ícone)",
  },
  {
    name: "errorMessage",
    type: "string",
    description: "Mensagem de erro exibida abaixo do campo quando error=true",
  },
  { name: "icon", type: "ReactNode", description: "Ícone exibido à esquerda do campo" },
  {
    ...
    type: '"default" | "dark"',
    default: '"default"',
    description: "Variante de tema — use dark em fundos Navy",
  },
    ...
    <div className="space-y-10" style={{ fontFamily: "var(--font-sans)" }}>
      <div className="space-y-2">
        ...
        <p className="text-lg" style={{ color: "var(--muted-foreground)" }}>
          Campo de texto com suporte a label, hint, estados de erro e variante escura. O focus ring
          usa Mint 500 (cor de anel da marca).
        </p>
      </div>
