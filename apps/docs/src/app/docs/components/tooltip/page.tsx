    ...
    <div className="space-y-10" style={{ fontFamily: "var(--font-sans)" }}>
      <div className="space-y-2">
        ...
        <p className="text-lg" style={{ color: "var(--muted-foreground)" }}>
          Label flutuante exibida ao passar o mouse. Renderizado via portal para evitar problemas de
          overflow. Construído sobre{" "}
      ...
      <section className="space-y-4">
        ...
        <div
          className="rounded-xl border p-8 flex gap-4 justify-center"
