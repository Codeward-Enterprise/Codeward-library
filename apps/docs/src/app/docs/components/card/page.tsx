...
import { Card, CardContent, CardDescription, CardDivider, CardFooter, CardHeader, CardHighlight, CardTitle } from "@/components/ui/card";

export const metadata: Metadata = { title: "Card" };

const props = [
  { name: "variant", type: '"default" | "dark"', default: '"default"', description: "Variante visual — dark usa fundo Navy" },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader>
              ...
              <h2 className="text-3xl font-medium" style={{ color: "var(--foreground)", fontFamily: "var(--font-sans)" }}>
                R$ 48.200
              </h2>
            </CardHeader>
            <CardContent>
          ...
          <CardHighlight>
            ...
            <CardContent>
              <ul className="space-y-2">
                {["Code review em todo PR", "Status diário", "Construímos para escalar"].map((item) => (
...
<CardHighlight>
  ...
  <CardFooter>
    <Button variant="cta">Iniciar projeto</Button>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-medium" style={{ color: "var(--foreground)" }}>Props — Card</h2>
