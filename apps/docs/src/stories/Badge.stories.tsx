...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Label compacta para status, categorias e contagens. `cta` (Mint 500) destaca o estado mais importante — use com moderação.",
      },
    },
  },
  argTypes: {
...
export const Sizes: Story = {
  ...
  render: () => (
    <Panel>
      <Label text="Sizes" />
      <Row>
        <Badge size="sm" variant="cta">
          sm
        </Badge>
        <Badge size="md" variant="cta">
          md
        </Badge>
        <Badge size="lg" variant="cta">
          lg
        </Badge>
      </Row>
    </Panel>
        ...
        {[
          {
            ...
            text: "Online",
            desc: "Latência média: 42ms",
          },
          {
            label: "Worker Queue",
            status: "warning" as const,
            text: "Degradado",
            desc: "Backlog: 1.247 jobs",
          },
          {
            label: "Storage",
            status: "destructive" as const,
            text: "Erro",
            desc: "Região us-east-1",
          },
        ].map((item) => (
          <div
            key={item.label}
