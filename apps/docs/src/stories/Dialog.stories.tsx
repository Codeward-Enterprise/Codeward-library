...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Modal acessível via Radix UI. Composto por `Dialog`, `DialogTrigger`, `DialogContent`, `DialogHeader`, `DialogTitle`, `DialogDescription`, `DialogFooter` e `DialogClose`.",
      },
    },
  },
    ...
    <Panel>
      <Dialog>
        <DialogTrigger asChild>
          <Button variant="primary">Abrir confirmação</Button>
        </DialogTrigger>
      ...
      <Dialog>
        ...
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Essa ação é permanente. O projeto <strong>api-gateway</strong> e todos os seus dados
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" size="sm">
              <TrashIcon /> Deletar permanentemente
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
  ...
  render: () => {
    ...
    return (
      <Panel>
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="cta">Convidar membro</Button>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Convidar para o time</DialogTitle>
              <DialogDescription>
                Envie um convite por e-mail. O acesso é liberado assim que o usuário aceitar.
              </DialogDescription>
            </DialogHeader>
