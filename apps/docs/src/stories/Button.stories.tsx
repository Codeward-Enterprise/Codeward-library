...
const Panel = ({ children, width = "auto" }: { children: React.ReactNode; width?: string }) => (
  <div style={{ background: "#252528", padding: "2rem", borderRadius: "12px", width, border: "1px solid #333337" }}>
    {children}
  </div>
);
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Primitiva de ação principal. `primary` para ações padrão; `cta` (Mint 500) é o destaque único por tela — regra 60-30-10.",
      },
    },
  },
  argTypes: {
    variant: { control: "select", options: ["primary", "cta", "secondary", "outline", "ghost", "link", "destructive"] },
    size: { control: "select", options: ["xs", "sm", "md", "lg", "xl", "icon", "icon-sm", "icon-lg"] },
...
export const Sizes: Story = {
  ...
  render: () => (
    <Panel><Label text="Sizes" /><Row>
      <Button size="xs" variant="cta">xs</Button>
      <Button size="sm" variant="cta">sm</Button>
      <Button size="md" variant="cta">md</Button>
      <Button size="lg" variant="cta">lg</Button>
      <Button size="xl" variant="cta">xl</Button>
    </Row></Panel>
  ),
};
export const WithIcons: Story = {
  name: "Com ícones",
  render: () => (
    <Panel><Label text="With icons" /><Row>
      <Button variant="cta"><Plus /> Novo projeto</Button>
      <Button variant="primary"><Settings /> Configurações</Button>
      <Button variant="outline"><ArrowRight /> Ver detalhes</Button>
...
export const PairExample: Story = {
  ...
  render: () => (
    <Panel width="360px">
      <p style={{ color: "#F6F9FC", fontFamily: "Inter, sans-serif", fontSize: "18px", fontWeight: 600, margin: "0 0 6px" }}>Pronto para começar?</p>
      <p style={{ color: "#5F6B7A", fontFamily: "Inter, sans-serif", fontSize: "13px", margin: "0 0 24px" }}>Construa seu produto com o suporte do time Codeward.</p>
      <Row>
...
export const Disabled: Story = {
  ...
  render: () => (
    <Panel><Label text="Disabled" /><Row>
      <Button variant="primary" disabled>Primary</Button>
      <Button variant="cta" disabled>CTA</Button>
